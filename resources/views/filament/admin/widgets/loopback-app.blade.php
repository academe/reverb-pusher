<div class="flex flex-wrap items-start gap-4 rounded-xl border border-gray-200 bg-white p-5 dark:border-white/10 dark:bg-gray-900">
    ...
    <div class="min-w-0 flex-1 space-y-2">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
            A built-in app used by the Diagnostics page to test your Reverb connection end-to-end.
            It is not stored in the database — credentials are derived from
            <code class="rounded bg-gray-100 px-1 py-0.5 text-xs dark:bg-white/5">APP_KEY</code>
            and take effect after you restart Reverb.
        </p>
    ...
    <div class="shrink-0">
        <x-filament::button
            href="{{ route('filament.admin.pages.reverb-diagnostics') }}"
            tag="a"
            size="sm"
